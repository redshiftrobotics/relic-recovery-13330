...
public class Timer1 {
     ...
     * @return The difference in time in milliseconds between when the timer started and now.
     */
    ...
    /**
     * Function to determine if a specific amount of time has passed in milliseconds.
